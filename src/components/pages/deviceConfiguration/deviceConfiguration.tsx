...
// //                   </Link>
// //                   {/* <button className={`${styles.dltButton}`}>DELETE</button>s */}
// //                 </div>
...
//   const removeDevice = async (id: string) => {
//     try {
//       const response = await axios.delete(`${API_BASE_URL}/config/camera/${id}`);
//       console.log("Device deleted successfully", response);
//       fetchData();
//     } catch (error) {
//       console.error("Failed to delete device", error);
...
//         <div>
//           <Link to="/AddDevice-Screen">
//             <button className={styles.btnedit} onClick={() => handleEdit(row.camera_id)}>
//               <FiEdit2 />
//             </button>
//           </Link>
//           <button
//             className={styles.btndelete}
//             onClick={() => handleDeleteClick(row.camera_id)}
//           >
//             <AiOutlineDelete />
//           </button>
//         </div>
...
//     <div className={`${styles.TopMainContainer} container-fluid`} style={{ backgroundColor: "#F5F5F5", overflow: "hidden" }}>
//       <div className="row">
//         <div className="col-md-2 col-5">
//           <SideBarMenu />
//         </div>
    ...
    },
    {
      ...
      cell: (row: Device) => (
        <div>
          ...
          <button className={styles.btndelete} onClick={() => handleDelete(row.camera_id)}>
            <AiOutlineDelete />
          </button>
        </div>
      ),
          ...
          <div className={styles.deviceTableContainer}>
            <div className={styles.mainContainer}>
              <div className={styles.buttonContainer}>
                <div>
                  <div className={styles.topContent} style={{ display: "flex", gap: "10px" }}>
                    <img src={camera} alt="" className={styles.filterButtonIcon} />
                    Device Configuration
                  </div>
                  <br />
                  <Link to="/AddDevice-Screen" className={styles.linkButton}>
